...
> = {
	...
	meta: {
		modelProps: "image" | "imageVariant" | "user" | "oAuthAccount";
		...
		ImageVariant: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.ImageVariantCountAggregateOutputType>
						| number;
				};
			};
		};
...
export type ImageVariantScalarFieldEnum =
	(typeof ImageVariantScalarFieldEnum)[keyof typeof ImageVariantScalarFieldEnum];
...
/**
 * Reference to a field of type 'ImageVariantType'
 */
export type EnumImageVariantTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	"ImageVariantType"
>;
 ...
 * Reference to a field of type 'ImageVariantType[]'
 */
export type ListEnumImageVariantTypeFieldRefInput<$PrismaModel> =
	FieldRefInputType<$PrismaModel, "ImageVariantType[]">;
